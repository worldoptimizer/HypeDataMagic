...
w(b,"data-magic-source")||g.source,e=A(b.getAttribute("data-magic-key")),f="customData"==d?a.customData:B(d);if(f){var k=w(b,"data-magic-branch");f=k?C(a,f,k):f;if(f=C(a,f,e)){if("object"!=typeof f){k=b.getAttribute("data-magic-prefix")||"";var l=b.getAttribute("data-magic-append")||"";f=k+f+l}c=Object.assign(c||{},{data:f,source:d,key:e,handler:b.getAttribute("data-magic-handler")||f.handler||"text"});(c.type?c.type.replace("HypeScene","DataMagic").split():r?["DataMagicPreviewUpdate"]:["DataMagicPrepareForDisplay",
"DataMagicLoad"]).forEach(function(H){z(a,b,Object.assign(c,{type:H}))})}else t(a,b)}}}function t(a,b,c){c=c||{};c.type||(c.type="DataMagicUnload");c.handler=c.oldHandler||b.getAttribute("data-magic-handler")||"text";z(a,b,c)}function D(a){a.setAttribute("magic-rebuild-time",Math.floor(performance.now()))}function E(a,b){q[a.documentId()]||(q[a.documentId()]={changeObserver:new MutationObserver(function(c){c.forEach(function(d){if("attributes"==d.type){var e=d.target,f=d.attributeName,k=A(e.getAttribute(f));
d=d.oldValue;if(k!=d){var l;if(l=r)l=(l=e.getAttribute("magic-rebuild-time"))?100>performance.now()-parseInt(l):!1;if(!l)switch(f){case "data-magic-key":k?p(a,e):t(a,e);break;case "data-magic-source":case "data-magic-branch":t(a,e);m(a,e);break;case "data-magic-handler":t(a,e,{oldHandler:d}),m(a,e)}}}})}),options:{subtree:!0,attributes:!0,attributeFilter:["data-magic-key","data-magic-source","data-magic-branch","data-magic-handler"],attributeOldValue:!0},enable:function(){this.changeObserver.observe(b,
this.options)},disable:function(){this.changeObserver.disconnect()}})}function u(a){q[a.documentId()]&&q[a.documentId()].enable()}function x(a){q[a.documentId()]&&q[a.documentId()].disable()}function F(a,b,c){b&&b.querySelectorAll("[data-magic-key]").forEach(function(d){p(a,d,c)})}function m(a,b,c){b&&(b&&p(a,b,c),F(a,b,c))}function B(a){return g.sourceRedirect[a]?v[g.sourceRedirect[a]]||null:a?v[a]||null:v[g.source]||null}function A(a){if("string"==typeof a)return a.trim()}function C(a,b,c){if("object"==
typeof b&&"string"==typeof c){c=c.replace(/\[(\d+)\]/g,function(f,k){return"."+parseInt(k)});c=c.replace(/^\./,"");a=c.split(".");for(var d=0,e=a.length;d<e;++d){if("object"!=typeof b)return;c=a[d];if(!b.hasOwnProperty(c))return;b=b[c]}return b}}function w(a,b){if(!a||!a.id)return null;for(;a.parentNode&&!a.classList.contains("HYPE_scene");){if(a.hasAttribute(b))return a.getAttribute(b);a=a.parentNode}return null}function G(a,b,c){a.refresh=function(d){m(this,d||document.getElementById(this.currentSceneId()))};
...
0);window.getSelection().removeAllRanges()})}return{version:"1.1",setData:function(a,b){b=b||g.source;v[b]=a},getData:B,setDefault:function(a,b){g[a]=b},getDefault:function(a){return g[a]},addDataHandler:function(a,b){if("string"!=!typeof a)switch(typeof b){case "object":h[a]=Object.assign({},g.handlerMixin,b);break;case "function":h[a]=Object.assign({},g.handlerMixin,h.text),h[a].DataMagicPrepareForDisplay=b}}}}());