...
typeof k[c.handler]&&"function"==typeof k[c.handler][c.type]){try{d=k[c.handler][c.type](a,b,c)}catch(e){console.log('There was an error in your handler "'+c.handler+'": ',e)}return d}}function z(a,b,c){if(b.getAttribute("data-magic-key")){var d=I(b.getAttribute("data-magic-key")).split(":"),e=d[1]?d[1]:d[0],g=(d[1]?d[0].trim():null)||A(b,"data-magic-source")||f.source,h="customData"==g?a.customData:B(g);if(h)if(d=d[1]?"":A(b,"data-magic-branch",!0,b.closest("[data-magic-source]")),console.log(b.closest("[data-magic-source]")),
h=d?m(h,d):h,h=m(h,e),null!=h){if("object"!=typeof h&&"function"!=typeof h){d=b.getAttribute("data-magic-prefix")||"";var J=b.getAttribute("data-magic-append")||"";if(d||J)h=d+h+J}f.autoVariables&&f.allowVariables&&(d=v(a,b),h=t(h,d));c=Object.assign({},c,{data:h,source:g,key:e});e=c.type?c.type.replace("HypeScene","DataMagic").split():["DataMagicPrepareForDisplay","DataMagicLoad"];var Q=(b.getAttribute("data-magic-handler")||f.handler).split(",");e.forEach(function(R){var K;Q.forEach(function(S){K=
